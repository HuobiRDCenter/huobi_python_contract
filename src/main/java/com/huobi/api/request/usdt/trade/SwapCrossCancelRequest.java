...
@AllArgsConstructor
@Builder
public class SwapCrossCancelRequest {
    private String orderId;//订单ID(多个订单ID中间以","分隔,一次最多允许撤消10个订单)
    private String clientOrderId;//客户订单ID(多个订单ID中间以","分隔,一次最多允许撤消10个订单)
