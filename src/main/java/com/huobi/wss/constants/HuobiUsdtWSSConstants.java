...
public class HuobiUsdtWSSConstants {
    ...
    public static final String TRADE_DETAIL_SUB = "market.$contract_code.trade.detail"; // 4.订阅 Trade Detail 数据
    ...
    public static final String TRADE_DETAIL_REQ = "market.$contract_code.trade.detail";// 2.请求 Trade detail 数据
    ...
    public static final String ORDERS_CROSS_CONTRACT_CODE = "orders_cross.$contract_code"; // 2.订阅订单成交数据（sub）
    public static final String ACCOUNTS_CONTRACT_CODE = "accounts.$contract_code"; // 3.资产变动数据（sub）
    public static final String ACCOUNTS_CROSS_MARGIN_ACCOUNT = "accounts_cross.$margin_account"; // 4.资产变动数据（sub）
    public static final String POSITIONS_CONTRACT_CODE = "positions.$contract_code"; // 5.持仓变动更新数据（sub）
    public static final String POSITIONS_CROSS_CONTRACT_CODE = "positions_cross.$contract_code"; // 6.持仓变动更新数据（sub）
    public static final String PUBLIC_LIQUIDATION_ORDERS = "public.$contract_code.liquidation_orders"; // 7.订阅强平订单数据(免鉴权)（sub）
    public static final String PUBLIC_FUNDING_RATE = "public.$contract_code.funding_rate"; // 8.【通用】订阅资金费率推送(免鉴权)（sub）
    public static final String PUBLIC_CONTRACT_INFO = "public.$contract_code.contract_info"; // 9.【通用】订阅合约信息变动(免鉴权)（sub）
    public static final String TRIGGER_ORDER_CONTRACT_CODE = "trigger_order.$contract_code"; // 10.【逐仓】订阅计划委托订单更新(sub)
