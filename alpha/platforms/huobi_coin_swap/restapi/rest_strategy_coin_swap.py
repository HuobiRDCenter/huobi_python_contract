...
__all__ = ("HuobiCoinSwapRestStrategyAPI",)


class HuobiCoinSwapRestStrategyAPI:
    ...
    async def swap_trigger_order(self, contract_code, trigger_type, trigger_price, volume, direction, offset,
                                 order_price=None, order_price_type=None, lever_rate=None):

        uri = "/swap-api/v1/swap_trigger_order"
        body = {
    ...
    async def swap_trigger_cancel(self, contract_code, order_id):
        ...
        uri = "/swap-api/v1/swap_trigger_cancel"
        body = {
            "contract_code": contract_code,
            "order_id": order_id
        }
    ...
    async def swap_trigger_cancelall(self, contract_code, direction=None, offset=None):
        ...
        uri = "/swap-api/v1/swap_trigger_cancelall"
        body = {
            "contract_code": contract_code
        }
    ...
    async def swap_trigger_openorders(self, contract_code, page_index=None, page_size=None, trade_type=None):

        uri = "/swap-api/v1/swap_trigger_openorders"
        body = {
            "contract_code": contract_code
        }
    ...
    async def get_swap_trigger_hisorders(self, contract_code, trade_type, status, create_date, page_index=None,
        ...
        uri = "/swap-api/v1/swap_trigger_hisorders"
        body = {
            "contract_code": contract_code,
    ...
    async def swap_tpsl_order(self, contract_code, direction, volume, tp_trigger_price=None, tp_order_price=None,
        ...
        uri = "/swap-api/v1/swap_tpsl_order"
        body = {
            "contract_code": contract_code,
            "direction": direction,
            "volume": volume
    ...
    async def swap_tpsl_cancel(self, contract_code, direction, volume, tp_trigger_price=None, tp_order_price=None,
                               tp_order_price_type=None, sl_trigger_price=None, sl_order_price=None, sl_order_price_type=None):

        uri = "/swap-api/v1/swap_tpsl_cancel"
        body = {
            "contract_code": contract_code,
            "direction": direction,
            "volume": volume
    ...
    async def swap_tpsl_openorders(self, contract_code, page_index=None, page_size=None, trade_type=None):

        uri = "/swap-api/v1/swap_tpsl_openorders"
        body = {
            "contract_code": contract_code
        }
    ...
    async def get_swap_tpsl_hisorders(self, contract_code, status, create_date, page_index=None,
                                      page_size=None, sort_by=None):

        uri = "/swap-api/v1/swap_tpsl_hisorders"
        body = {
            "contract_code": contract_code,
            "status": status,
            "create_date": create_date
    ...
    async def swap_track_order(self, contract_code, direction, offset, volume, callback_rate, active_price,
                               order_price_type, lever_rate=None):

        uri = "/swap-api/v1/swap_track_order"
        body = {
            "contract_code": contract_code,
            "direction": direction,
            "offset": offset,
    ...
    async def swap_track_cancel(self, contract_code, order_id):
        ...
        uri = "/swap-api/v1/swap_track_cancel"
        body = {
            "contract_code": contract_code,
            "order_id": order_id
        }
    ...
    async def swap_track_cancelall(self, contract_code, direction=None, offset=None):
        ...
        uri = "/swap-api/v1/swap_track_cancelall"
        body = {
            "contract_code": contract_code
        }
    ...
    async def swap_track_openorders(self, contract_code, trade_type=None, page_index=None, page_size=None):
        ...
        uri = "/swap-api/v1/swap_track_openorders"
        body = {
            "contract_code": contract_code
        }
    ...
    async def swap_track_hisorders(self, contract_code, status, trade_type, create_date, page_index=None, page_size=None, sort_by=None):

        uri = "/swap-api/v1/swap_track_hisorders"
        body = {
            "contract_code": contract_code,
            "status": status,
            "trade_type": trade_type,
