...
class HuobiCoinSwapRestTradeAPI:
    ...
    async def swap_cancel_after(self, on_off, time_out=None):
    ...
    async def get_swap_order(self, contract_code, volume, direction, offset, lever_rate, order_price_type,
    ...
    async def swap_switch_lever_rate(self, contract_code, lever_rate):
        ...
        uri = "/swap-api/v1/swap_switch_lever_rate"
        body = {
            "contract_code": contract_code,
            "lever_rate": lever_rate
        }
    ...
    async def get_swap_order_detail(self, contract_code, order_id, created_at=None, order_type=None, page_index=None, page_size=None):

        uri = "/swap-api/v1/swap_order_detail"
        body = {
            "contract_code": contract_code,
            "order_id": order_id
        }
    ...
    async def get_swap_hisorders(self, contract, trade_type, type, status, start_time=None, end_time=None, direct=None,
                                 from_id=None):

        uri = "/swap-api/v3/swap_hisorders"
        body = {
            "contract": contract,
            "trade_type": trade_type,
            "type": type,
    ...
    async def get_swap_hisorders_exact(self, contract, trade_type, type, status, start_time=None, end_time=None,
                                       direct=None, from_id=None, price_type=None):

        uri = "/swap-api/v3/swap_hisorders_exact"
        body = {
            "contract": contract,
            "trade_type": trade_type,
            "type": type,
    ...
    async def get_swap_matchresults(self, contract, trade_type, start_time=None, end_time=None, direct=None, from_id=None):

        uri = "/swap-api/v3/swap_matchresults"
        body = {
            "contract": contract,
            "trade_type": trade_type
        }
    ...
    async def get_swap_matchresults_exact(self, contract, trade_type, start_time=None, end_time=None, direct=None,
                                          from_id=None):

        uri = "/swap-api/v3/swap_matchresults_exact"
        body = {
            "contract": contract,
            "trade_type": trade_type
        }
    ...
    async def swap_lightning_close_position(self, contract_code, volume, direction, client_order_id=None, order_price_type=None):

        uri = "/swap-api/v1/swap_lightning_close_position"
        body = {
            "contract_code": contract_code,
            "volume": volume,
            "direction": direction
