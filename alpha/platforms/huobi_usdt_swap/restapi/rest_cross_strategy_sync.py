...
class RestCrossStrategyUsdtSwap:
    ...
    def swap_cross_trigger_order(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_trigger_order"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_trigger_cancel(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_trigger_cancel"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_trigger_cancelall(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_trigger_cancelall"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_trigger_openorders(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_trigger_openorders"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_trigger_hisorders(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_trigger_hisorders"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_tpsl_order(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_tpsl_order"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_tpsl_cancel(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_tpsl_cancel"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_tpsl_cancelall(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_tpsl_cancelall"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_tpsl_openorders(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_tpsl_openorders"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_tpsl_hisorders(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_tpsl_hisorders"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_relation_tpsl_order(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_relation_tpsl_order"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_track_order(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_track_order"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_track_cancel(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_track_cancel"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_track_cancelall(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_track_cancelall"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_track_openorders(self, data: dict = None) -> json:
        path = "/linear-swap-api/v1/swap_cross_track_openorders"
        return post(self.access_key, self.secret_key, self.host, path, data)

    def swap_cross_track_hisorders(self, data: dict = None) -> json:
