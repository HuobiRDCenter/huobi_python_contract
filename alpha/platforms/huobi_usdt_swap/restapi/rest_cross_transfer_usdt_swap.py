...
__all__ = ("HuobiUsdtSwapRestCrossTransferAPI",)


class HuobiUsdtSwapRestCrossTransferAPI:
    ...
    async def get_swap_cross_transfer_state(self, margin_account=None):

        uri = "/linear-swap-api/v1/swap_cross_transfer_state"
        params = {
